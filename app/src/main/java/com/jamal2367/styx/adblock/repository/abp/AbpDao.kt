...
package com.jamal2367.styx.adblock.repository.abp
...
val ABP_ENTITY_EASYLIST = AbpEntity(title = "EasyList", entityId = 1, url = "https://easylist.to/easylist/easylist.txt", homePage = "https://easylist.to")
val ABP_ENTITY_EASYPRIVACY = AbpEntity(title = "EasyPrivacy", entityId = 2, url = "https://easylist.to/easylist/easyprivacy.txt", homePage = "https://easylist.to")
val ABP_ENTITY_URLHAUS = AbpEntity(title = "Urlhaus Malicious URL Blocklist", entityId = 3, url = "https://raw.githubusercontent.com/curbengh/urlhaus-filter/master/urlhaus-filter-agh-online.txt", homePage = "https://gitlab.com/curben/urlhaus-filter")
val ABP_ENTITY_ADGUARD = AbpEntity(title = "AdGuard Base Filter", entityId = 4, url = "https://filters.adtidy.org/extension/chromium/filters/2.txt", homePage = "https://github.com/AdguardTeam/AdguardFilters", enabled = false)
val ABP_DEFAULT_ENTITIES = setOf(ABP_ENTITY_EASYLIST.toString(), ABP_ENTITY_EASYPRIVACY.toString(), ABP_ENTITY_URLHAUS.toString(), ABP_ENTITY_ADGUARD.toString())
