...
val ABP_ENTITY_ADGUARD = AbpEntity(title = "AdGuard Base Filter", entityId = 1, url = "https://filters.adtidy.org/extension/chromium/filters/2.txt", homePage = "https://github.com/AdguardTeam/AdguardFilters")
...
val ABP_DEFAULT_ENTITIES = setOf(ABP_ENTITY_ADGUARD.toString(), ABP_ENTITY_EASYLIST.toString(), ABP_ENTITY_EASYPRIVACY.toString(), ABP_ENTITY_URLHAUS.toString())
