...
val ABP_ENTITY_ADGUARD = AbpEntity(title = "AdGuard Base Filter", entityId = 5, url = "https://filters.adtidy.org/extension/chromium/filters/2.txt", homePage = "https://github.com/AdguardTeam/AdguardFilters", enabled = false)
